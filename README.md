...
<img src="./NMPtestScreenshot.png" width="800px" />
...
### 5. Path fix in test file

Please update the Line number 11 and 12 with following code

```
deleteFile(`${__dirname}/path/to/apps/task.txt`);
deleteFile(`${__dirname}/path/to/apps/completed.txt`);
```
